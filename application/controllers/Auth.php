...
class Auth extends CI_Controller {
	...
	public function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				redirect('welcome/layouts', 'refresh');
			}
			else
			{
	...
	public function create_user()
    {
        ...
        else
        {
            ...
            $this->data['alert'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('alert')));

            $this->data['nome_site'] = array(
                'name'  => 'nome_site',
                'id'    => 'nome_site',
                'type'  => 'text',
                'class' => 'form-control',
                ...
                'required' => '',
                'value' => $this->form_validation->set_value('nome_site'),
            );
