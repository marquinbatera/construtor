            ...
            <div role="main" class="col-md-8 col-md-push-2">
                <div class="modif row bloco" id="drop1" data-pos="1">
                    <div class="col-md-12">
                        ...
                        <div class="ibox">
                            <div class="conteudo_contato ibox-content" id="conteudo_contato">
                                <div class="row">
                                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Contato</h3>
                                        ...
                                        <form role="form">
                                            ...
                                            <div>
                                                <button class="btn_contato btn btn-sm btn-primary pull-right m-t-n-xs" id="btn_contato" type="submit"><strong>Enviar</strong></button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-md-6">
