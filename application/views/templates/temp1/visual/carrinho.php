                ...
                <div class="row bloco" id="drop1" data-pos="1">
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <h5 class="titulo_carrinho" id="titulo_carrinho">Itens do carrinho</h5>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table shoping-cart-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="desc">
                                            <h3>
                                            <a href="#" class="text-navy title_prod" id="txt_prod">
                        ...
                        <div class="ibox-content">
                            ...
                            <button class="btn_checkout btn btn-primary pull-right" id="btn_checkout"><i class="fa fa fa-shopping-cart"></i> Checkout</button>
