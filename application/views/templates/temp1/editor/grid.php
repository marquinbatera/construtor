<!-- Header -->
<input type="hidden" id="id_page" value="grid">
                                        ...
                                        <div class="ibox-content product-box">
                                            ...
                                            <div class="product-desc">
                                                ...
                                                <div class="m-t text-righ">
                                                    ...
                                                    <a href="#" class="btn btn-xs btn-outline btn-primary loucoo">Adicionar <i class="fa fa-long-arrow-right"></i> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="ibox-content product-box">
                                            ...
                                            <div class="product-desc">
                                                ...
                                                <div class="m-t text-righ">
                                                    ...
                                                    <a href="#" class="btn btn-xs btn-outline btn-primary">Adicionar <i class="fa fa-long-arrow-right"></i> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
