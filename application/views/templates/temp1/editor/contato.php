<!-- Header -->
<input type="hidden" id="id_page" value="contato">
            ...
            <div role="main" class="col-md-8 col-md-push-2">
                <div class="modif row bloco" id="drop1" data-pos="1">
                    <div class="col-md-12">
                        ...
                        <div class="ibox">
                            <div class="modif conteudo_contato ibox-content editable" elemento=".conteudo_contato" funcao="edicao_fundo" id_caixa="#conteudo_contato" id="conteudo_contato">
                                <div class="row">
                                    <div class="col-sm-6 b-r"><h3 class="m-t-none m-b">Contato</h3>
                                        ...
                                        <form role="form">
                                            ...
                                            <div>
                                                <button class="modif btn_contato btn btn-sm btn-primary pull-right m-t-n-xs editable" elemento=".btn_contato" funcao="edicao_botao" id_caixa="#btn_contato" id="btn_contato" type="submit"><strong>Enviar</strong></button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-md-6">
