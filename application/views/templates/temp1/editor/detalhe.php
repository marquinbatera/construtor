                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <h2 class="modif title_prod font-bold m-b-xs editable" elemento=".title_prod" funcao="edicao_texto_fundo" id_caixa="#title_prod" id="title_prod">
                                    Desktop publishing software
                                </h2>
                                <div class="m-t-md">
                                    <h2 class="modif txt_price product-main-price editable" elemento=".txt_price" funcao="edicao_texto_fundo" id_caixa="#txt_price" id="txt_price">$406,602</h2>
                                </div>
                                <hr>

                                <div class="modif desc_prod small text-muted editable" elemento=".desc_prod" funcao="edicao_texto_fundo" id_caixa="#desc_prod" id="desc_prod">
                                ...
                                <dl class="modif detalhe_prod small m-t-md editable" elemento=".detalhe_prod" funcao="edicao_texto_fundo" id_caixa="#detalhe_prod" id="detalhe_prod">
                                ...
                                <div>
                                    <div class="btn-group">
                                        <button class="modif btn_adicionar btn btn-primary btn-sm editable" elemento="#btn_adicionar" funcao="edicao_botao" id_caixa="#btn_adicionar" id="btn_adicionar"><i class="fa fa-cart-plus"></i> Adicionar ao carrinho</button>
