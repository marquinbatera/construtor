<?php $this->load->view('templates/temp1/editor/partials/header');?>
<!-- Header -->
<input type="hidden" id="id_page" value="home">
                    ...
                    <div id="produtos" class="content">
                        <div class="col-md-2">
                            <div class="modif panel panel-primary editable" id="format-corpo-categoria" style="border: none;">
                                ...
                                <div class="panel-body editable" elemento=".botao-categoria" funcao="edicao_texto_link" id_caixa="#listCategoria" id="listCategoria"> 
                                        ...
                                        <div class="modif product-box ibox-content" id="box-prod">
                                            ...
                                            <div class="product-desc">
                                                ...
                                                <div class="m-t text-righ">
                                                    ...
                                                    <a href="javascript:" class="modif botao-adicionar btn btn-xs btn-outline btn-primary editable" elemento=".botao-adicionar" funcao="edicao_texto_link" id_caixa="#btn_adicionar" id="btn_adicionar">Adicionar <i class="fa fa-long-arrow-right"></i> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="<?php echo base_url(); ?>assets/construtor/js/plugins/owl/bootstrap-collapse.js"></script>
    <script src="<?php echo base_url(); ?>assets/construtor/js/plugins/owl/bootstrap-transition.js"></script>
    <script src="<?php echo base_url(); ?>assets/construtor/js/plugins/owl/bootstrap-tab.js"></script>

    <script src="<?php echo base_url(); ?>assets/construtor/js/plugins/owl/google-code-prettify/prettify.js"></script>
    <script src="<?php echo base_url(); ?>assets/construtor/js/plugins/owl/application.js"></script>