<!-- Header -->
<input type="hidden" id="id_page" value="sobre">
        ...
        <div class="row">
            <div role="main" class="col-md-8 col-md-push-2">
                <div class="modif row bloco" id="drop1" data-pos="1">
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="modif ibox-content editable" elemento=".ibox-content" funcao="edicao_fundo" id_caixa="#conteudo_sobre" id="conteudo_sobre">
                                <div class="text-center article-title">
                                    <h1 class="modif title_sobre editable" elemento=".title_sobre" funcao="edicao_texto_fundo" id_caixa="#titulo_sobre" id="titulo_sobre">
                                        Behind the word mountains
                                    </h1>
                                </div>
                                <div class="modif texto_sobre editable" elemento=".texto_sobre" funcao="edicao_texto_fundo" id_caixa="#texto_sobre" id="texto_sobre">
