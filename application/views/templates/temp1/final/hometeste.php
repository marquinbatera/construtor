        ...
        <div class="row">
            <div role="main" class="col-md-8 col-md-push-2" id="ordem">
                ...
                <div class="modif row" id="drop3" data-pos="3">
                    <div id="produtos" class="modif content">
                        <div class="col-md-2">
                            <div class="panel panel-primary editable" id="format-corpo-categoria" style="border: none;">
                                <div class="panel-heading luis editable" elemento="#format-corpo-categoria" funcao="edicao_fundo" id_caixa="#format-corpo-categoria">
                                ...
                                <div class="panel-body editable" elemento=".botao-categoria" funcao="edicao_botao" id_caixa="#listCategoria" id="listCategoria"> 
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 1</a>
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 2</a>
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 3</a>
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 4</a>
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 5</a>
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 6</a>
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 7</a>
                                    <a href="javascript:" class="btn btn-default btn-block botao-categoria">Categoria 8</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="ibox">
                                        <div class="modif product-box ibox-content">
