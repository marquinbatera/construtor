...
<!-- Navigation -->
            <nav class="modifmenu menuAll navbar navbar-default resize-bloco editable" elemento=".menuAll" funcao="edicao_fundo" id_caixa="#menu" id="menu" role="navigation" style="height: 100px; margin-top: 61px;">
                <div class="container">
